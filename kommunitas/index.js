...
const KOM_STAKING_CONTRACT_POLYGON = [
    ...
    "0xdf81D4ddAF2a728226f6f5e39a61BFc5236203C0"
];
...
const KOM_LP_TOKEN_CONTRACT_POLYGON = '0xe0a1fd98e9d151babce27fa169ae5d0ff180f1a4';
const KOM_LP_STAKING_CONTRACT_POLYGON = ["0xdf81d4ddaf2a728226f6f5e39a61bfc5236203c0"];

module.exports = {
    polygon: {
        tvl: () => ({}),
        staking: {
            0: stakings(KOM_STAKING_CONTRACT_POLYGON, KOM_TOKEN_CONTRACT_POLYGON)
            1: stakings(KOM_LP_STAKING_CONTRACT_POLYGON, KOM_LP_TOKEN_CONTRACT_POLYGON)
        }
    },
    arbitrum: {
        tvl: () => ({}),
